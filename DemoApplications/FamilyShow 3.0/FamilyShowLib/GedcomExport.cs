...
namespace Microsoft.FamilyShowLib
{
    ...
    public class GedcomExport
    {
        ...
        private void ExportMarriage(Person partnerLeft, Person partnerRight, SpouseRelationship relationship)
        {
            ...
            {
                WriteLine(GetLevel(relationship), ResolveRelationship(relationship, partnerLeft.Gender),
            ...
            if (partnerRight != null && partnerRight.Gender == Gender.Male)
                WriteLine(GetLevel(relationship), 
                          ResolveRelationship(relationship, partnerRight.Gender), 
                          string.Format(CultureInfo.InvariantCulture, 
                                        "@{0}@", 
                                        idMap.Get(partnerRight.Id)));
        ...
        private string ResolveRelationship(SpouseRelationship rel, Gender gender)
        {
        ...
        private int GetLevel(SpouseRelationship rel)
        {
            var rand = new Random();
