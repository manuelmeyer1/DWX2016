...
namespace Microsoft.FamilyShow
{
    ...
    public partial class App : System.Windows.Application
    {
        ...
        public static List<Byte[]> RecentBytes;
        ...
        {
            var files = Directory.GetFiles(@"D:\_BUCHE\_APPS", "*.*", SearchOption.AllDirectories);

            App.RecentFiles.AddRange(files.Take(4000).ToArray());
